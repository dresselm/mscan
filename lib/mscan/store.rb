...
module Mscan # :nodoc:
  ...
  module Store
    ...
    ROOT_OUTPUT_DIR           = Mscan::Config.output_directory
    # The output directory for composite scan files
    COMPOSITE_SCAN_OUTPUT_DIR = File.join(ROOT_OUTPUT_DIR, 'scans')
    # The output directory for analysis files
    ANALYSIS_OUTPUT_DIR       = File.join(ROOT_OUTPUT_DIR, 'analysis')
    ...
    module ClassMethods # :nodoc:
      ...
      def save(full_path, content={})
        ...
        File.open(full_path, 'w+') do |f|
          f.write(Yajl::Encoder.encode(content))
        end
        full_path
      end
